...
Change the AEM server details in .env.development for local development

Model Manager with Model Client can be used to fetch the model from remote AEM servers
